...
def args_config():
    ...
    parse.add_argument('--mix_alpha', type=float, default=8, help='mixup parameters')
    ...
    parse.add_argument('--aug_batch_size', type=int, default=16, help='batch size of augmentation dataset')
    ...
    #parse.add_argument('--genre', choices=['all', 'bc', 'bn', 'tc', 'wb', 'nw', 'mz'], default='all', help='the type of domain corpus')
