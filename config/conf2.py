...
def args_config():
    ...
    parse.add_argument('--bert_grad_clip', type=float, default=1., help='the max norm of gradient clip for bert')
    ...
    parse.add_argument('--use_aug_crf', action='store_true', default=True, help='use the augmentation crf solely')
    parse.add_argument('--train_type', choices=['vanilla', 'aug'], default='vanilla', help='training mode')
    parse.add_argument('--genre', type=str, help='dataset genre')
    parse.add_argument('--aug_genre', type=str, help='augmented dataset genre')
    parse.add_argument('--aug_batch_size', type=int, default=8, help='batch size of augmentation dataset')
    ...
    parse.add_argument('--epoch', type=int, default=50, help='number of training')
    ...
    parse.add_argument("--bert_layer", type=int, default=1, help='the number of last bert layers')
